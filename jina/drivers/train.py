...
class ContrastiveLossTrainDriver(BaseTrainDriver):
    def __init__(
            self,
            *args,
            **kwargs,
    ...
    def _apply_all(self, docs: 'DocumentSet', *args, **kwargs) -> None:
        contrastive_training_docs = ContrastiveLossDocSet(docs)
...
class ContrastiveLossTrainExecutor(BaseTrainExecutor):
